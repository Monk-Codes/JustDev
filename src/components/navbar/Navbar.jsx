...
export default function Nav() {
 ...
 return (
  <>
   {/* Navbar  */}
   <Navbar className="sticky inset-0 z-20 h-max max-w-full border-none rounded-none py-2 px-4 lg:px-8 lg:py-2" style={{ background: mode === "dark" ? "var(--sec-color)" : "var(--light-color)" }}>
    {/* Desktop View  */}
     ...
     <div className="flex items-center gap-4">
      ...
      <div>
       {mode === "light" ? (
        <>
         {/* Light Button  */}
         <IconButton onClick={toggleMode} className=" lg:inline-block rounded-full" style={{ background: mode === "light" ? "#DDE6ED" : "#45474B", color: mode === "dark" ? "white" : "black" }}>
        ...
        <>
         {/* Dark Button  */}
         <IconButton onClick={toggleMode} className=" lg:inline-block rounded-full" style={{ background: mode === "light" ? "#DDE6ED" : "#45474B" }}>
      ...
      {/* Mobile Toggle  */}
      <div>
       <IconButton className="ml-auto h-10 w-10 text-inherit rounded-lg lg:hidden" ripple={false} onClick={() => setOpenNav(!openNav)} style={{ background: mode === "light" ? "#DDE6ED" : "#45474B", color: mode === "dark" ? "white" : "black" }}>
        {openNav ? (
